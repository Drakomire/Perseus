...
def init():
    ...
    skills = json.loads(j)
    f = open(os.path.join(dir,"src/ships/data/ships.json"), "w")
    ...
    types = json.loads(j)
    f = open(os.path.join(dir,"src/ships/data/types.json"), "w")
    ...
    f = open(os.path.join(dir,"src/ships/data/retrofit.json"), "w")
    ...
    skills = json.loads(j)
    f = open(os.path.join(dir,"src/ships/data/skills.json"), "w")
    f.write(json.dumps(skills))
    f.close()
    del f
    ...
    f = open(os.path.join(dir,"src/ships/data/nicknames.json"), "w")
    f.write(content.decode('utf-8'))
    f.close()
    del f
    ...
    f = open(os.path.join(dir,"src/ships/data/lookup_table.json"), "w")
    f.write(content.decode('utf-8'))
    f.close()
    del f
